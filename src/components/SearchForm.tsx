...
export const SearchForm: React.FC<SearchFormProps> = ({
  ...
  // Renderizar o formulário em uma variável separada para evitar problemas no Chrome
  const searchFormContent = !hasResults ? (
  ...
  return (
    <div key={hasResults ? 'results' : 'search'} className="bg-white rounded-lg shadow-lg p-6 mb-6">
